<?php
		...
		if(isset($_GET['id']))
		{
			if(preg_match("/^[0-9]{1,}$/", $_GET['id']))
			{
				...
				MYSQL_SELECT("select * from employee where e_id=".$_GET['id'],$sess_name,3);
...
<title>SPA System - Admin - Employee - Edit</title>
...
<body>
	...
	<div class='container'>
		...
		<form action='functions/employee_edit.php' method='post' enctype="multipart/form-data">
					...
					<div class='form-group'>
						<input type='submit' class='form-control' value='Update Employee'/>
					</div>
